...
function Home(props) {
    ...
    return (
        <section id="#" className="home-section pt-7 w-screen h-screen overflow-hidden mb-0"
            ...
            <div style={{background: props.theme === 'light' ? 'rgba(255, 255, 255, 0.4)' : 'transparent'}}
                 className="grid h-full w-full ml-0 mt-0">
                <div id="my-image"
                     className="col-12 lg:col-6 flex justify-content-center lg:justify-content-end align-items-center lg:pr-8">
                    <Image src={require(`../assets/home/me_${props.theme}.webp`)} width="250"
                           imageClassName="border-circle"/>
                </div>
                <div className="flex flex-column w-full lg:w-max justify-content-center align-items-center mb-8">
                    <About props={props}/>
